...
theme.set_highlights = function(opts)
    ...
    hl(0, 'String', { fg = c.vscOrange, bg = 'NONE', italic = opts.italic_comments })
    ...
    hl(0, 'Function', { fg = c.vscYellow, bg = 'NONE', italic = true })
    ...
    hl(0, 'Typedef', { fg = c.vscBlue, bg = 'NONE', italic = true })
    ...
    hl(0, 'htmlArg', { fg = c.vscLightBlue, bg = 'NONE', italic = true })
